                    ...
                    <div className="relative">
                        <Link to="/home" state={{ type: "Men" }}>
                            <img
                                ...
                                alt=""
                            />
                            <button className="text-black border border-black font-semibold rounded-xl px-4 py-1 text-2xl absolute bottom-3 left-5 hover:bg-black hover:text-white hover:scale-110">
                                Men
                            </button>
                        </Link>
                    </div>
